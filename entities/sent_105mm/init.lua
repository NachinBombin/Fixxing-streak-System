...
function ENT:Initialize()	
	...
	for k,v in pairs(player.GetAll()) do
		local pos = v:GetPos()
		sound.Play("ac-130_kill_sounds/105mminair.wav",pos,180,100,1)
...
function ENT:Explosion()
	...
	timer.Simple(.5, function() self:CountDeadBodys(targets) self.Entity:Remove() end)
